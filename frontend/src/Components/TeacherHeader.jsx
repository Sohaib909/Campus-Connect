  ...
  return (
    <nav className="bg-blue-900 dark-bg-black">
      ...
      <div className="max-w-screen-xl mx-auto flex items-center justify-between p-4 relative">
        <Link to="/TeacherHomePage" className="flex items-center">
          <img
        ...
        <div className="flex items-center md:order-2">
          <div className="relative mr-4 text-gray-300">
            ...
            {showNotifications && (
              <div
                ref={dropdownRef}
                className="absolute top-full right-0 mt-2 bg-white rounded-lg shadow-lg z-50 dark-bg-gray-800"
                style={{
                  width: "auto",
                  minWidth: "200px",
                  maxHeight: "400px",
        ...
        <div className="hidden md:flex md:w-auto md:order-1" id="navbar-user">
          <ul className="flex flex-col font-bold md:flex-row md:space-x-8 dark-bg-gray-800 dark-border-gray-700">
            <Link
              to="/Folder"
              className="transition-transform transform   focus:text-[#FF9503] text-white text-lg"
            >
              Course Material
            </Link>
            ...
            <Link to="/CampusNews" className="focus:text-[#FF9503] text-white">
              Campus News
            </Link>
            <Link
              to="/AppointmentsPage"
              className="focus:text-[#FF9503] text-white"
            >
              Appointments
            </Link>
          </ul>
