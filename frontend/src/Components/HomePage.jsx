...
const HomePage = () => {
  ...
  return (
    <div className="bg-blue-950 w-full flex flex-col relative min-h-screen">
      <video
        src="bgvid.mp4"
        autoPlay="{true}"
        loop
      ...
      <div className="max-w-6xl mx-auto p-8 flex flex-col items-center relative z-10">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 relative mt-8">
            <div className="my-2 w-full shadow-2xl rounded-lg relative overflow-hidden  top-0 right-0">
              {/* Carousel */}
              <Carousel
                showThumbs={false}
                autoPlay={true}
      ...
      {/* <div className="justify-center items-center sm:mt-24 mt-4 ">
        <Features />
      </div> */}
      <section className="text-white">
        <div className="container flex flex-col-reverse mx-auto lg:flex-row">
            ...
            <div className="flex space-x-2 sm:space-x-4">
              ...
              <div className="space-y-2 z-10">
                <Link to="/BookAppointment">
                  ...
                  <p className="leadi">
                    Our website offers, you can easily browse and check the
          ...
          <div className="lg:w-1/2 xl:w-3/5 dark:bg-gray-800">
            <div className="flex items-center justify-center h-96 mb-6 p-4 md:p-8 lg:p-12">
              <Lottie
