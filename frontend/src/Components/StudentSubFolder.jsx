...
const StudentSubFolder = () => {
  ...
  const navigateToCourseUpload = (folderId, folderType) => {
    navigate(`/course-materials/${folderId}/${folderType || "main"}`, {
      state: { folderId },
    });
  };
  ...
  return (
    <div className="bg-blue-950 min-h-screen flex flex-col justify-center items-center">
      ...
      <h2 className="text-5xl font-bold text-white mb-4 mt-4">Courses</h2>
      <br />
      <div>
...
export default StudentSubFolder;
